...
function Success() {
    return (
        <div id="mobile-success">
            ...
            <div className="mobile-cards" data-aos="fade-up">
                <div className="mobile-card-container3">
                    <img
                        src="img/success-logo.png"
                        alt="NovaLaw Logo"
                        className="mobile-nova-logo"
                    />
                    <h2 className="mobile-success-card-title">
                        사건에 관련해서 현실적인 조언과
                        <br />
                        앞으로의 계획에 대해
                        <br />
                    ...
                    <p className="mobile-success-card-text">
                        우선 엄청 친절하십니다.
                        <br />
                        현재 놓인 상황에 법률적인 얘기를 명쾌하게 얘기해주시고
                        앞으로 어떻게 해야 할지 계획도
                        <br />
                        얘기해주셔서 너무 감사했습니다.
                        <br />
                        중간중간 이해를 못한 부분도 친절히 설명해주시고 더
                        궁금한 것은 없는지 물어보고 더 대답해주시려는 모습이
                        인상깊었습니다. 감사합니다.
                    </p>
                    <img
                        src="img/goso-sosong.png"
                        alt="고소/소송절차분야"
                        className="mobile-success-parts"
                    />
                    <div className="mobile-success-card-bottom">
                        <p>2024.03</p>
                        <p>전화상담</p>
                        <p>의뢰인 wh******</p>
                    </div>
                ...
                <div className="mobile-card-container3">
                    ...
                    <p className="mobile-success-card-text">
                        처음에 상담 신청을 할 때 변호사에 대한 딱딱하고 엄격한
                        이미지가 있어서 긴장했으나 정말 따뜻하게 상담을
                ...
                <div className="mobile-card-container3">
                    ...
                    <p className="mobile-success-card-text">
                        ...
                        가지 고민이 많아지게 되는데, 든든하게 말씀을 해 주시니
                        편한 마음으로 진행할 수 있었습니다. 정말 감사드립니다!
                    </p>
                    <img
                        src="img/goso-sosong.png"
                        alt="고소/소송절차분야"
