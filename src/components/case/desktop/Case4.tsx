    ...
    return (
        <div id="case">
            ...
            <div className="result-container" data-aos="fade-up">
                ...
                <p>
                    법원은 이돈호 변호사의 주장을 받아들여 원심의 형이 무겁다고
                    판단하였고,
                    <br />
                    1심 벌금형을 파기하여 <strong>선고유예를 선고</strong>
                    하였습니다.
                    <br />
                    <br />
                    <strong>
                        이는 이돈호 변호사만의 수많은 경험과 노하우를 바탕으로
                        한
                        <br />
                        충실한 소명 노력으로 이끌어낸 결과라 할 것입니다.
                    </strong>
                </p>
            </div>
            ...
            <p className="reason-text" data-aos="fade-up">
                ...
                <br />
                법원은 이러한 주장을 받아들여 원심의 형이 무겁다고 판단하고, 1심
                벌금형을 파기하여 선고유예를 선고하였습니다.
                <br />
                <br />
