        ...
        <div id="case">
            ...
            <div className="result-container" data-aos="fade-up">
                ...
                <p>
                    ...
                    <br />
                    <strong>양형사유에 변동이 없음</strong>에도 이돈호 변호사의
                    주장을 받아들여
                    <br />
                    <br />
                    원심의 형이 무겁다고 판단하였고,{" "}
            ...
            <p className="reason-text" data-aos="fade-up">
                ...
                <br />
                피해자 진술의 신빙성을 탄핵하기 위해 증인신문 절차를
                진행하였습니다.
                <br />
                <br />
                이돈호 변호사는 증인신문 과정에서 피해자가 거짓말을 하고 있다는
                점을 밝히려고 노력하였고,
                <br />
                협박 및 상해 부분에서 사실관계를 바로잡고자 하였습니다.
                <br />
                <br />
                또한, 의뢰인이 잘못된 행동에 대해 진심으로 반성하는 모습을
                재판부에 피력하고,
                <br />
                피해자가 의뢰인의 범죄 행위나 피해를 과장하고 있음을
                주장하였습니다.
                <br />
                <br />
                재판부는 이돈호 변호사의 주장을 받아들여 원심의 형이 무겁다고
                판단하여 징역 1년을 징역 10개월로 감형하였습니다.
                <br />
